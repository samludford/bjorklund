class Bjorklund {
  ...
  public boolean[] getRhythm(int total, int beats) 
  {
    if(beats > total) return null;
    
    boolean[] input = new boolean[total];
  ...
  private boolean[] bjorklund(boolean[][] input) 
  {
  ...
  private boolean isStoppingCase(boolean[][] input) {
  ...
  private boolean[][] iterate(boolean[][] input) {
  ...
  private boolean[][] format(boolean[] input) 
  {
  ...
  private boolean[] unFormat(boolean[][] input) {
